...
Think of your own scenario and create a class to represent it and a matching spec file for your tests.

If you're stuck, have a look around you and choose an object from the real world. What data (attributes) does the object have? What actions (methods) can it perform?
